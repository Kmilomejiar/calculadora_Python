# Calculadora Grafica con tkinter
from os import system
from tkinter import *

ventana = Tk()
ventana.geometry("300x325")
ventana.title("Calculadora con Python")
...
boton0 = Button(ventana, text="0", width= 5, height=2, command= lambda: clic_boton(0))

boton_borrar = Button(ventana, text="AC", width= 5, height= 2, bg= "white", command= lambda: borrar())
...
boton_dividir = Button(ventana, text="/", width= 5, height= 2, command= lambda: clic_boton("/"))
boton_multiplicar = Button(ventana, text="x", width= 5, height= 2, command= lambda: clic_boton("*"))
boton_sumar = Button(ventana, text="+", width= 5, height= 2, command= lambda: clic_boton("+"))
boton_restar = Button(ventana, text="-", width= 5, height= 2, command= lambda: clic_boton("-"))
boton_negativo = Button(ventana, text="+/-", width= 5, height= 2, command= lambda: clic_boton("-"))
boton_igual = Button(ventana, text="=", width= 13, height= 2, command= lambda: operacion())
...
boton_multiplicar.grid(row = 2, column = 3, padx = 5)
...
boton_igual.grid(row = 5, column = 2, columnspan= 2, padx= 10, pady= 10)
